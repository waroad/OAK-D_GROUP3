            ...
            if hand.lm_score > self.tracker.lm_score_thresh:
                ...
                if self.show_landmarks:
                    ...
                    if self.tracker.use_gesture:
                        ...
                        # print(kkk, hand.thumb_state, hand.index_state, hand.middle_state, hand.ring_state,hand.little_state)
                        ...
                        if kkk:
                            ...
                            if hand.little_state == 0:
                                snake.change('RIGHT')
                        elif kkk==0 and hand.thumb_state==0 and hand.index_state==0 and \
                                hand.middle_state==0 and hand.ring_state==0 and hand.little_state==0:
                            thread1 = threading.Thread(target=snake.begin)
                            thread1.start()
                            kkk=1
                            print(dir(hand))
                    else:
